...
# Topic: Music success trajectories on the Billboard Hot 100
# Dataset: final_sample_cleaned.csv
# Scope: Billboard Top 10 hits entering the Hot 100 between 2000 and 2021
#
# Guardrails:
# - This script does not rebuild or alter the data-cleaning pipeline.
# - The sample is restricted to already successful Top 10 songs.
# - Regression results are associative, not causal.
# - ML evaluates predictive performance, not causal explanation.
# - AUC/ROC is not appropriate because the ML targets are continuous outcomes.
################################################################################
...
# The modeling script starts from the cleaned song-level sample and does not redo matching or feature construction.
# ------------------------------------------------------------------------------
...
# These checks protect the exact thesis sample, outcomes, controls, and feature blocks before any model is fit.
# ------------------------------------------------------------------------------
...
# The main OLS models compare whether audio and lyric blocks add explanatory value beyond the controls.
# ------------------------------------------------------------------------------
...
# Coefficient-level findings are corrected because the combined models test many predictors across four outcomes.
# ------------------------------------------------------------------------------
...
# This table distills the explanatory results into the thesis-level comparison of feature blocks.
# ------------------------------------------------------------------------------
...
# Alternative models check whether outcome scale and distributional assumptions drive the main OLS patterns.
# ------------------------------------------------------------------------------
...
# ML is treated as a predictive extension and is compared with cross-validated OLS and a fold-specific null mean baseline.
# ------------------------------------------------------------------------------
